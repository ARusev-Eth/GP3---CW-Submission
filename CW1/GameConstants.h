...
#define WINDOW_TITLE "Future Earth - post-invasion !! 8546 PAD = Camera Movement, Shift - Camera Switch, Arrows Deploy secret weapon"
...
//Camera movements
extern bool switchCam;
extern bool fwd, bck, lft, rght;
