...
cStarfield::cStarfield(GLint theTextureID1,GLint theTextureID2, glm::vec3 theFieldVolume)
{
	srand((unsigned)time(NULL));
	setRotAngle(0.0f);
	glGetFloatv(GL_ALIASED_POINT_SIZE_RANGE, m_AliasedPointSizes);
	m_NumStars = 1000;
	m_TextureID1 = theTextureID1;
	m_TextureID2 = theTextureID2;
